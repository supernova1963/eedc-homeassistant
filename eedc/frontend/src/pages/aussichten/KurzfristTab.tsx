  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
        <KPICard
          title={`Summe ${chartData.length} Tage`}
          value={summeKwh.toFixed(0)}
          unit="kWh"
          color="yellow"
          icon={Zap}
        />
        ...
        <KPICard
          ...
          value={durchschnittKwh.toFixed(1)}
          unit="kWh"
          color="blue"
          icon={Sun}
        />
        ...
        {heute && (
          <KPICard
            ...
            subtitle={heute.pv_ertrag_morgens_kwh != null
        ...
        {morgen && (
          <KPICard
            title="Morgen"
            value={(morgen.pv_ertrag_kwh ?? 0).toFixed(1)}
            unit="kWh"
            color="gray"
            icon={(p) => <WetterIcon symbol={morgen.wetter_symbol} {...p} />}
            subtitle={morgen.pv_ertrag_morgens_kwh != null
