...
from backend.api.routes import anlagen, monatsdaten, investitionen, strompreise, import_export, pvgis, cockpit, wetter, aussichten, prognosen, solar_prognose, monatsabschluss, community, data_import, connector, cloud_import, custom_import, system_logs, daten_checker, diagnostics, aktueller_monat, live_dashboard, live_mqtt_inbound, live_wetter, energie_profil, mqtt_gateway, mqtt_presets, infothek, dokumentation
