...
- **Speicher: die Kapazitäts-Basis der Vollzyklen ist festgeschrieben.** Zyklen und Wirtschaftlichkeit rechnen im ganzen Programm gegen die **Brutto**-Kapazität; das optionale Feld **nutzbare Kapazität** (die Reserve-bereinigte Größe — wer 10/90 fährt, trägt bei 10 kWh brutto 8 ein) verfeinert ausschließlich den gemessenen Wirkungsgrad. Ein irreführender Code-Kommentar behauptete das Gegenteil und hätte den HA-Sensor gegen den Monatsbericht laufen lassen; die Konvention steht jetzt in [Berechnungen §3.3](docs/BERECHNUNGEN.md#33-speicher-einsparung) und ist durch einen Test gesichert. **Für Nutzer ändert sich keine Zahl.** Hintergrund der Rückfrage: eedc nimmt keinen Ziel-SOC an — Vollzyklen und Wirkungsgrad kommen aus gemessenen Lade-/Entlademengen. *(Rainer, PN)*
