...
- **Prognosen** basierend auf echten Wetterdaten und historischen Erträgen
- **Community-Vergleich** für realistische Einordnung der eigenen Anlage

## Technologie

- **Backend:** Python/FastAPI mit SQLite
- **Frontend:** React/TypeScript mit Vite
- **Deployment:** Docker Container oder Home Assistant Add-on
- **Wetterdaten:** DWD (Bright Sky), Open-Meteo, PVGIS
- **Lizenz:** Open Source
...
- [Entwickler-Dokumentation](/eedc-homeassistant/docs/entwicklung/)
