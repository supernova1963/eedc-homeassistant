...
| 10 | **Abgabe an Dritte** — dritter Weg der Netzpunkt-Bilanz (§9.2) | groß | ⏳ **im Bau seit 05.09.2026** (Commit 1: Registry, Fakten, Layer, Monat/Jahr/Export/Community; Commit 2: Tag + Live; Commit 3: Anzeige, Daten-Checker, Handbuch). Eintrag im Dict, bis der letzte Commit steht. |
