...
GET /api/cockpit/nachhaltigkeit/{anlage_id}              # CO2-Bilanz (Cockpit/Jahr, ganze Historie — kein ?jahr=)
...
>
> | Kategorie | Bedeutung | Stand nach S6 |
> | --- | --- | --- |
