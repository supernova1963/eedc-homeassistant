...
>
> | Kategorie | Bedeutung | Stand nach C1b |
> | --- | --- | --- |
...
> | `P10_NOCH_NICHT_MIGRIERT` | faltet eine **anlagenweite** Monatszeile selbst — die Klasse, die P10 schließen soll | **2**, mit Obergrenze im Test |
>
