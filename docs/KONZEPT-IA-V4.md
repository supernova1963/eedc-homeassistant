...
| I12 | **SoT-Komponenten-Pflicht (Regel 0/0a):** eine Komponenten-Klasse = EINE Komponente (KPICard, Button, CsvExportButton, Modal, ChartTooltip/-Legende, Table/WerteTabelle, KpiStrip, **SegmentControl, Switch, ReloadButton, InlineAktion, ErfassungZustandBadge, AnteilDonut, KomponentenFinanzTabelle** …). Register: [`IA-V4-SOT-INVENTAR`](IA-V4-SOT-INVENTAR.md). Neues erweitert die Zentrale — nie ein Zweitbau fürs bestehende Pattern. | Style-Guide Regel 0/0a + Teil B · SoT-Inventar | Review + das **Wächter-Register** (25 `check:*`, `package.json` — s. Register-Notiz unter der Tabelle, Stand 2026-07-20) |
