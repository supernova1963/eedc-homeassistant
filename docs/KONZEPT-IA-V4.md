...
>
> **Default-Klappregel (2026-06-19, Gernot — Cockpit/Monat-Referenz):** Im *Erstzustand* einer Sicht (bevor der Nutzer eigene Klapp-Zustände gesetzt hat) ist nur die **Zahlen-Zusammenfassung** offen — in Cockpit/Monat konkret **Kennzahlen** (KPI-Strip) + **Energie-Bilanz**; alle übrigen Blöcke (Tagesverlauf, Komponenten-Sektionen, Community, Finanzen) starten **eingeklappt**. Einstieg ist damit der ablesbare Überblick, Details öffnet der Nutzer gezielt. Sobald ein Nutzer Klapp-Zustände gesetzt hat, gilt seine persistierte Wahl (B6).
