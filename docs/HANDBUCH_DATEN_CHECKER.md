...
| **\[Name\]: Warmwasser-Wärme in N Monat(en) gespeichert — eine Split-Klimaanlage hat keinen Warmwasserkreis** | ℹ️ INFO | An einem Gerät der Art **Luft-Luft (Klimaanlage)** steht ein Warmwasser-Wert. Solche Geräte haben keinen Warmwasserkreis; eedc bietet das Feld dort seit 2026 nicht mehr an, ältere Einträge blieben aber stehen. **Der Wert zählt nicht als Wärme des Geräts** — sonst stünde dort eine Ersparnis gegenüber der Heizung, die das Gerät nie erzeugt hat. | Stammt der Wert aus dem **Kühlbetrieb**, trag ihn unter *Nutzenergie Kuehlbetrieb* ein — daraus rechnet eedc die **Arbeitszahl Kühlen**. Der gespeicherte Wert bleibt unverändert stehen, bis du ihn selbst umträgst; eedc löscht und verschiebt nichts von allein. |
...
> **Und eine dritte Spur, die nicht bei dir liegt: die Einstrahlung der letzten Tage ist vorläufig.** Den Strahlungswert holt eedc beim Wetterdienst. Für Tage, die weiter als fünf Tage zurückliegen, kommt er aus dem endgültigen Messarchiv; für die Tage davor gibt es das Archiv noch nicht, eedc nimmt dort den Modellwert. Der ist im Mittel gut, an **bewölkten** Tagen aber deutlich zu klein — und ein zu kleiner Vergleichsmaßstab treibt die Performance Ratio nach oben, ohne dass an deiner Anlage etwas falsch wäre. **Seit eedc 4.0.39 holt eedc den endgültigen Wert von selbst nach**, sobald ein Tag alt genug ist; ein Verdacht, der nur an solchen Tagen hing, verschwindet damit binnen weniger Tage von allein. Wenn dein Verdacht also **ausschließlich** auf den letzten Tagen sitzt und dort auf trübe Tage fällt, lohnt sich das Abwarten, bevor du in deiner Einrichtung suchst.
