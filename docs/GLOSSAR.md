...
| **Netto-Ertrag (PV)** | Was die PV-Anlage einbringt: Einspeiseerlös + Eigenverbrauchs-Ersparnis (+ Sonstige Erträge − Sonderkosten), bei Regelbesteuerung **abzüglich der USt auf den Eigenverbrauch**. **Ohne** Netzbezug-Kosten — die fielen auch ohne PV an — und **ohne** Wärmepumpen-/E-Mobilitäts-Ersparnis. Ein Erzeuger unter „Sonstiges" (BHKW, Windrad, Wasserkraft) **zählt hier mit** — er speist hinter denselben Hauszähler, und was er einspeist oder an Netzbezug ersetzt, steckt in Erlös und Ersparnis. Bewertet wird dabei das **Gerät** nicht: es hat keine eigene Ertrags-Zeile und keine Wirtschaftlichkeit, sein Ertrag wird am Gerät als „Ertrag/Jahr" gepflegt. Kennzahl im Block „Finanz-Übersicht" ([Auswertungen → Finanzen](HANDBUCH_BEDIENUNG.md#3-auswertungen)). Siehe [Berechnungen §3.1](BERECHNUNGEN.md). |
